...
public class StringMethod {
	...
	// var1 is storing string in lowecase
	...
	public static void main(String[] args) {
		...
		// JAVA CASE SENSITIVE so we are using to lower case first as var is in capital
		// letter
		...
		System.out.println("Replace method is used to replace particular string with new string "
				+ var1.replace("Manual", "Automation"));
		...
		// Split is used to divide the string but as java is machine we need to tell how
		// you want to do split
